...
<table class="table table-striped">
    <thead>
        <tr><th>Name</th><th>Group</th><th class="text-end">Price</th><th class="text-center">Sort</th><th>Status</th><th>Actions</th></tr>
    </thead>
    <tbody>
        <?php foreach ($modifiers as $m): ?>
            <tr>
                <td><?= e($m['name']) ?></td>
                <td>
                    <?php $grp = $m['modifier_group'] ?? 'beverage'; ?>
                    <span class="badge bg-<?= $grp === 'loose_tea' ? 'success' : 'info' ?>">
                        <?= $grp === 'loose_tea' ? 'Loose Tea' : 'Beverage' ?>
                    </span>
                </td>
